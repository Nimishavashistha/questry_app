...
router.post("/upvotes",middleware.checkToken, async (req, res) => {
  Post.findByIdAndUpdate(req.body.postId,{
...
router.post("/undoUpvotes",middleware.checkToken, async (req, res) => {
Post.findByIdAndUpdate(req.body.postId,{
...
router.post("/downvotes",middleware.checkToken, async (req, res) => {
Post.findByIdAndUpdate(req.body.postId,{
...
router.post("/undoDownvotes",middleware.checkToken, async (req, res) => {
Post.findByIdAndUpdate(req.body.postId,{
